                      ...
                      children: [
                        ...
                        Row(
                          children: const [
                            ...
                            SizedBox(width: 4),
                            Text('4.9 (101 ulasan)', style: TextStyle(fontSize: 14)),
                          ],
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            const Text('Rp 1.950.000', style: TextStyle(color: Colors.blue, fontSize: 16.0)),
                            _AnimatedBuyButton(),
                          ],
                        ),
                      ...
                      children: [
                        ...
                        Row(
                          children: const [
                            Icon(Icons.star, color: Colors.amber, size: 16),
                            SizedBox(width: 4),
                            Text('4.8 (242 ulasan)', style: TextStyle(fontSize: 14)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            const Text('Rp 1.350.000', style: TextStyle(color: Colors.blue, fontSize: 16.0)),
                            _AnimatedBuyButton(),
                          ],
                        ),
                        const SizedBox(height: 6),
